      ...
      <div className="container col-md-6 col-lg-6 col-xs-12 col-sm-6 h-100">
        <div className="row d-flex align-items-center justify-content-center h-100">
                          ...
                          <div className="card">
                              ...
                              <h1 className="font-weight-bold " style={{ textAlign: "center" }}>Request sent successfully!</h1>
            ...
            {({ values, handleChange, handleSubmit }) => (
                <form onSubmit={handleSubmit}>
                   <TextField className='mt-4' fullWidth label="Enter Your Email"
                      ...
                      />       
                    <TextField className='mt-4' fullWidth label="Enter 6-digit code"
                    ...
                    />
                    <TextField
                     className='mt-4' fullWidth type="password" label="Confirm New Password" /*id="confirmPassword" onChange={handleChange} value={values.password}*/
                    />    

<Button variant ="contained" type='submit' className='mt-4 mx-auto d-flex'fullWidth>Change Password</Button>
                     <Button
                          /*variant="contained" color='error'*/ className='mt-2 mx-auto d-flex'>Resend code</Button>
            </form>
            )}
            </Formik>
            </div>
