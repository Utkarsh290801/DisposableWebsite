                  ...
                  {({ values, handleChange, handleSubmit }) => (
                    <form onSubmit={handleSubmit}>
                      ...
                      <TextField
                        ...
                        fullWidth
                        type="password"
                        label="New Password" /*id="newPassword" onChange={handleChange} value={values.password}*/
                      />
                      <TextField
                        className="mt-4"
                        fullWidth
                        type="password"
                        label="Confirm Password" /*id="confirmPassword" onChange={handleChange} value={values.password}*/
                      />
                      ...
                      <Button
                        /*variant="contained" color='error'*/ className="mt-5"
                      >
                        Cancel
                      </Button>
                    </form>
